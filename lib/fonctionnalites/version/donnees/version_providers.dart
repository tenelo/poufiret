...
/// Repository de contrôle de version (Dio nu, sans auth, pool partagé).
...
///
/// Au lancement, main() démarre déjà l'appel (en parallèle de l'init
/// Firebase) et surcharge ce provider avec ce Future : aucun second appel.
