...
mixin _$PartenaireVitrine {
 ...
 int get id;@JsonKey(name: 'nom_commerce') String get nomCommerce;@JsonKey(name: 'type_partenaire') String get typePartenaire;@JsonKey(name: 'type_partenaire_libelle') String get typeLibelle; String get description; String? get logo;@JsonKey(name: 'photo_couverture') String? get photoCouverture; String get adresse; String get quartier; String get secteur; String get ville; String get departement; String get region;@JsonKey(name: 'description_acces') String get descriptionAcces;@JsonKey(name: 'telephone_pro') String get telephonePro; String get whatsapp;@JsonKey(name: 'email_pro') String get emailPro;@JsonKey(name: 'nb_vues') int get nbVues;@JsonKey(name: 'nombre_likes') int get nombreLikes;@JsonKey(name: 'est_like_par_moi') bool get estLikeParMoi;@JsonKey(name: 'est_favori_par_moi') bool get estFavoriParMoi;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,nomCommerce,typePartenaire,typeLibelle,description,logo,photoCouverture,adresse,quartier,secteur,ville,departement,region,descriptionAcces,telephonePro,whatsapp,emailPro,nbVues,nombreLikes,estLikeParMoi,estFavoriParMoi]);

@override
String toString() {
  return 'PartenaireVitrine(id: $id, nomCommerce: $nomCommerce, typePartenaire: $typePartenaire, typeLibelle: $typeLibelle, description: $description, logo: $logo, photoCouverture: $photoCouverture, adresse: $adresse, quartier: $quartier, secteur: $secteur, ville: $ville, departement: $departement, region: $region, descriptionAcces: $descriptionAcces, telephonePro: $telephonePro, whatsapp: $whatsapp, emailPro: $emailPro, nbVues: $nbVues, nombreLikes: $nombreLikes, estLikeParMoi: $estLikeParMoi, estFavoriParMoi: $estFavoriParMoi)';
}
...
@useResult
$Res call({
 int id,@JsonKey(name: 'nom_commerce') String nomCommerce,@JsonKey(name: 'type_partenaire') String typePartenaire,@JsonKey(name: 'type_partenaire_libelle') String typeLibelle, String description, String? logo,@JsonKey(name: 'photo_couverture') String? photoCouverture, String adresse, String quartier, String secteur, String ville, String departement, String region,@JsonKey(name: 'description_acces') String descriptionAcces,@JsonKey(name: 'telephone_pro') String telephonePro, String whatsapp,@JsonKey(name: 'email_pro') String emailPro,@JsonKey(name: 'nb_vues') int nbVues,@JsonKey(name: 'nombre_likes') int nombreLikes,@JsonKey(name: 'est_like_par_moi') bool estLikeParMoi,@JsonKey(name: 'est_favori_par_moi') bool estFavoriParMoi
});
...
/// Create a copy of PartenaireVitrine
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? nomCommerce = null,Object? typePartenaire = null,Object? typeLibelle = null,Object? description = null,Object? logo = freezed,Object? photoCouverture = freezed,Object? adresse = null,Object? quartier = null,Object? secteur = null,Object? ville = null,Object? departement = null,Object? region = null,Object? descriptionAcces = null,Object? telephonePro = null,Object? whatsapp = null,Object? emailPro = null,Object? nbVues = null,Object? nombreLikes = null,Object? estLikeParMoi = null,Object? estFavoriParMoi = null,}) {
...
as String,nbVues: null == nbVues ? _self.nbVues : nbVues // ignore: cast_nullable_to_non_nullable
as int,nombreLikes: null == nombreLikes ? _self.nombreLikes : nombreLikes // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id, @JsonKey(name: 'nom_commerce')  String nomCommerce, @JsonKey(name: 'type_partenaire')  String typePartenaire, @JsonKey(name: 'type_partenaire_libelle')  String typeLibelle,  String description,  String? logo, @JsonKey(name: 'photo_couverture')  String? photoCouverture,  String adresse,  String quartier,  String secteur,  String ville,  String departement,  String region, @JsonKey(name: 'description_acces')  String descriptionAcces, @JsonKey(name: 'telephone_pro')  String telephonePro,  String whatsapp, @JsonKey(name: 'email_pro')  String emailPro, @JsonKey(name: 'nb_vues')  int nbVues, @JsonKey(name: 'nombre_likes')  int nombreLikes, @JsonKey(name: 'est_like_par_moi')  bool estLikeParMoi, @JsonKey(name: 'est_favori_par_moi')  bool estFavoriParMoi)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PartenaireVitrine() when $default != null:
return $default(_that.id,_that.nomCommerce,_that.typePartenaire,_that.typeLibelle,_that.description,_that.logo,_that.photoCouverture,_that.adresse,_that.quartier,_that.secteur,_that.ville,_that.departement,_that.region,_that.descriptionAcces,_that.telephonePro,_that.whatsapp,_that.emailPro,_that.nbVues,_that.nombreLikes,_that.estLikeParMoi,_that.estFavoriParMoi);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id, @JsonKey(name: 'nom_commerce')  String nomCommerce, @JsonKey(name: 'type_partenaire')  String typePartenaire, @JsonKey(name: 'type_partenaire_libelle')  String typeLibelle,  String description,  String? logo, @JsonKey(name: 'photo_couverture')  String? photoCouverture,  String adresse,  String quartier,  String secteur,  String ville,  String departement,  String region, @JsonKey(name: 'description_acces')  String descriptionAcces, @JsonKey(name: 'telephone_pro')  String telephonePro,  String whatsapp, @JsonKey(name: 'email_pro')  String emailPro, @JsonKey(name: 'nb_vues')  int nbVues, @JsonKey(name: 'nombre_likes')  int nombreLikes, @JsonKey(name: 'est_like_par_moi')  bool estLikeParMoi, @JsonKey(name: 'est_favori_par_moi')  bool estFavoriParMoi)  $default,) {final _that = this;
switch (_that) {
case _PartenaireVitrine():
return $default(_that.id,_that.nomCommerce,_that.typePartenaire,_that.typeLibelle,_that.description,_that.logo,_that.photoCouverture,_that.adresse,_that.quartier,_that.secteur,_that.ville,_that.departement,_that.region,_that.descriptionAcces,_that.telephonePro,_that.whatsapp,_that.emailPro,_that.nbVues,_that.nombreLikes,_that.estLikeParMoi,_that.estFavoriParMoi);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id, @JsonKey(name: 'nom_commerce')  String nomCommerce, @JsonKey(name: 'type_partenaire')  String typePartenaire, @JsonKey(name: 'type_partenaire_libelle')  String typeLibelle,  String description,  String? logo, @JsonKey(name: 'photo_couverture')  String? photoCouverture,  String adresse,  String quartier,  String secteur,  String ville,  String departement,  String region, @JsonKey(name: 'description_acces')  String descriptionAcces, @JsonKey(name: 'telephone_pro')  String telephonePro,  String whatsapp, @JsonKey(name: 'email_pro')  String emailPro, @JsonKey(name: 'nb_vues')  int nbVues, @JsonKey(name: 'nombre_likes')  int nombreLikes, @JsonKey(name: 'est_like_par_moi')  bool estLikeParMoi, @JsonKey(name: 'est_favori_par_moi')  bool estFavoriParMoi)?  $default,) {final _that = this;
switch (_that) {
case _PartenaireVitrine() when $default != null:
return $default(_that.id,_that.nomCommerce,_that.typePartenaire,_that.typeLibelle,_that.description,_that.logo,_that.photoCouverture,_that.adresse,_that.quartier,_that.secteur,_that.ville,_that.departement,_that.region,_that.descriptionAcces,_that.telephonePro,_that.whatsapp,_that.emailPro,_that.nbVues,_that.nombreLikes,_that.estLikeParMoi,_that.estFavoriParMoi);case _:
  return null;
...
class _PartenaireVitrine extends PartenaireVitrine {
  const _PartenaireVitrine({required this.id, @JsonKey(name: 'nom_commerce') this.nomCommerce = '', @JsonKey(name: 'type_partenaire') this.typePartenaire = '', @JsonKey(name: 'type_partenaire_libelle') this.typeLibelle = '', this.description = '', this.logo, @JsonKey(name: 'photo_couverture') this.photoCouverture, this.adresse = '', this.quartier = '', this.secteur = '', this.ville = '', this.departement = '', this.region = '', @JsonKey(name: 'description_acces') this.descriptionAcces = '', @JsonKey(name: 'telephone_pro') this.telephonePro = '', this.whatsapp = '', @JsonKey(name: 'email_pro') this.emailPro = '', @JsonKey(name: 'nb_vues') this.nbVues = 0, @JsonKey(name: 'nombre_likes') this.nombreLikes = 0, @JsonKey(name: 'est_like_par_moi') this.estLikeParMoi = false, @JsonKey(name: 'est_favori_par_moi') this.estFavoriParMoi = false}): super._();
...
/// Create a copy of PartenaireVitrine
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? nomCommerce = null,Object? typePartenaire = null,Object? typeLibelle = null,Object? description = null,Object? logo = freezed,Object? photoCouverture = freezed,Object? adresse = null,Object? quartier = null,Object? secteur = null,Object? ville = null,Object? departement = null,Object? region = null,Object? descriptionAcces = null,Object? telephonePro = null,Object? whatsapp = null,Object? emailPro = null,Object? nbVues = null,Object? nombreLikes = null,Object? estLikeParMoi = null,Object? estFavoriParMoi = null,}) {
