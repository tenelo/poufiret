...
const Set<String> ecransSansBandeau = {'discussion', 'panier'};
      ...
      builder: (context, sensible, _) {
        ...
        return ValueListenableBuilder<int>(
          ...
          builder: (context, profondeur, _) {
            ...
            // Decalage minimum pour que le bandeau ne colle jamais au bord bas,
            // meme sur un ecran pousse (livraison, restaurant...) sans barre.
