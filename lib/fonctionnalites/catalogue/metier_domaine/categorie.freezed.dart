...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Categorie&&(identical(other.id, id) || other.id == id)&&(identical(other.nom, nom) || other.nom == nom)&&(identical(other.slug, slug) || other.slug == slug)&&(identical(other.description, description) || other.description == description)&&(identical(other.icone, icone) || other.icone == icone)&&(identical(other.imageCouverture, imageCouverture) || other.imageCouverture == imageCouverture)&&(identical(other.parent, parent) || other.parent == parent)&&(identical(other.modeTransaction, modeTransaction) || other.modeTransaction == modeTransaction)&&(identical(other.ordre, ordre) || other.ordre == ordre)&&const DeepCollectionEquality().equals(other.typesArticles, typesArticles)&&(identical(other.afficheCatalogue, afficheCatalogue) || other.afficheCatalogue == afficheCatalogue)&&const DeepCollectionEquality().equals(other.typesPartenaire, typesPartenaire)&&(identical(other.estActive, estActive) || other.estActive == estActive)&&(identical(other.nbPartenaires, nbPartenaires) || other.nbPartenaires == nbPartenaires)&&const DeepCollectionEquality().equals(other.enfants, enfants));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,nom,slug,description,icone,imageCouverture,parent,modeTransaction,ordre,const DeepCollectionEquality().hash(typesArticles),afficheCatalogue,const DeepCollectionEquality().hash(typesPartenaire),estActive,nbPartenaires,const DeepCollectionEquality().hash(enfants));

@override
String toString() {
  return 'Categorie(id: $id, nom: $nom, slug: $slug, description: $description, icone: $icone, imageCouverture: $imageCouverture, parent: $parent, modeTransaction: $modeTransaction, ordre: $ordre, typesArticles: $typesArticles, afficheCatalogue: $afficheCatalogue, typesPartenaire: $typesPartenaire, estActive: $estActive, nbPartenaires: $nbPartenaires, enfants: $enfants)';
}
...
/// Create a copy of Categorie
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? nom = null,Object? slug = null,Object? description = null,Object? icone = null,Object? imageCouverture = freezed,Object? parent = freezed,Object? modeTransaction = null,Object? ordre = null,Object? typesArticles = null,Object? afficheCatalogue = null,Object? typesPartenaire = null,Object? estActive = null,Object? nbPartenaires = freezed,Object? enfants = null,}) {
...
as List<String>,afficheCatalogue: null == afficheCatalogue ? _self.afficheCatalogue : afficheCatalogue // ignore: cast_nullable_to_non_nullable
as bool,typesPartenaire: null == typesPartenaire ? _self.typesPartenaire : typesPartenaire // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _Categorie() when $default != null:
return $default(_that.id,_that.nom,_that.slug,_that.description,_that.icone,_that.imageCouverture,_that.parent,_that.modeTransaction,_that.ordre,_that.typesArticles,_that.afficheCatalogue,_that.typesPartenaire,_that.estActive,_that.nbPartenaires,_that.enfants);case _:
  return orElse();
...
class _Categorie implements Categorie {
  const _Categorie({required this.id, required this.nom, required this.slug, this.description = '', this.icone = '', @JsonKey(name: 'image_couverture') this.imageCouverture, this.parent, @JsonKey(name: 'mode_transaction') this.modeTransaction = '', this.ordre = 0, @JsonKey(name: 'types_articles') final  List<String> typesArticles = const <String>[], @JsonKey(name: 'affiche_catalogue') this.afficheCatalogue = true, @JsonKey(name: 'types_partenaire') final  List<String> typesPartenaire = const <String>[], @JsonKey(name: 'est_active') this.estActive = true, @JsonKey(name: 'nb_partenaires') this.nbPartenaires, final  List<Categorie> enfants = const <Categorie>[]}): _typesArticles = typesArticles,_typesPartenaire = typesPartenaire,_enfants = enfants;
...
@override@JsonKey(name: 'affiche_catalogue') final  bool afficheCatalogue;
 final  List<String> _typesPartenaire;
@override@JsonKey(name: 'types_partenaire') List<String> get typesPartenaire {
  if (_typesPartenaire is EqualUnmodifiableListView) return _typesPartenaire;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(_typesPartenaire);
}
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Categorie&&(identical(other.id, id) || other.id == id)&&(identical(other.nom, nom) || other.nom == nom)&&(identical(other.slug, slug) || other.slug == slug)&&(identical(other.description, description) || other.description == description)&&(identical(other.icone, icone) || other.icone == icone)&&(identical(other.imageCouverture, imageCouverture) || other.imageCouverture == imageCouverture)&&(identical(other.parent, parent) || other.parent == parent)&&(identical(other.modeTransaction, modeTransaction) || other.modeTransaction == modeTransaction)&&(identical(other.ordre, ordre) || other.ordre == ordre)&&const DeepCollectionEquality().equals(other._typesArticles, _typesArticles)&&(identical(other.afficheCatalogue, afficheCatalogue) || other.afficheCatalogue == afficheCatalogue)&&const DeepCollectionEquality().equals(other._typesPartenaire, _typesPartenaire)&&(identical(other.estActive, estActive) || other.estActive == estActive)&&(identical(other.nbPartenaires, nbPartenaires) || other.nbPartenaires == nbPartenaires)&&const DeepCollectionEquality().equals(other._enfants, _enfants));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,nom,slug,description,icone,imageCouverture,parent,modeTransaction,ordre,const DeepCollectionEquality().hash(_typesArticles),afficheCatalogue,const DeepCollectionEquality().hash(_typesPartenaire),estActive,nbPartenaires,const DeepCollectionEquality().hash(_enfants));
...
as List<String>,afficheCatalogue: null == afficheCatalogue ? _self.afficheCatalogue : afficheCatalogue // ignore: cast_nullable_to_non_nullable
as bool,typesPartenaire: null == typesPartenaire ? _self._typesPartenaire : typesPartenaire // ignore: cast_nullable_to_non_nullable
as List<String>,estActive: null == estActive ? _self.estActive : estActive // ignore: cast_nullable_to_non_nullable
as bool,nbPartenaires: freezed == nbPartenaires ? _self.nbPartenaires : nbPartenaires // ignore: cast_nullable_to_non_nullable
