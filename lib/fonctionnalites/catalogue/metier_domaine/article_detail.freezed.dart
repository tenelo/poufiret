...
class _ArticleDetail extends ArticleDetail {
  const _ArticleDetail({required this.id, required this.nom, required this.slug, this.description = '', this.type = '', this.prix = '0', @JsonKey(name: 'prix_promotion') this.prixPromotion, this.unite = '', @JsonKey(name: 'est_disponible') this.estDisponible = true, @JsonKey(name: 'est_actif') this.estActif = true, @JsonKey(name: 'est_en_promotion') this.estEnPromotion = false, @JsonKey(name: 'nb_vues') this.nbVues = 0, @JsonKey(name: 'nb_likes') this.nbLikes = 0, @JsonKey(name: 'nb_favoris') this.nbFavoris = 0, @JsonKey(name: 'nb_commentaires') this.nbCommentaires = 0, @JsonKey(name: 'partenaire_nom') this.partenaireNom = '', this.partenaire, this.categorie, @ImagesUrlConverter() final  List<String> images = const <String>[], final  List<Variante> variantes = const <Variante>[], final  List<Supplement> supplements = const <Supplement>[], @JsonKey(name: 'est_like_par_moi') this.estLikeParMoi = false, @JsonKey(name: 'est_favori_par_moi') this.estFavoriParMoi = false}): _images = images,_variantes = variantes,_supplements = supplements,super._();
...
@override@JsonKey()@ImagesUrlConverter() List<String> get images {
