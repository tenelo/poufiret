...
switch (_that) {
case _Categorie() when $default != null:
return $default(_that.id,_that.nom,_that.slug,_that.description,_that.icone,_that.imageCouverture,_that.parent,_that.modeTransaction,_that.ordre,_that.typesArticles,_that.afficheCatalogue,_that.estActive,_that.nbPartenaires,_that.enfants);case _:
  return orElse();
...
class _Categorie implements Categorie {
  const _Categorie({required this.id, required this.nom, required this.slug, this.description = '', this.icone = '', @JsonKey(name: 'image_couverture') this.imageCouverture, this.parent, @JsonKey(name: 'mode_transaction') this.modeTransaction = '', this.ordre = 0, @JsonKey(name: 'types_articles') final  List<String> typesArticles = const <String>[], @JsonKey(name: 'affiche_catalogue') this.afficheCatalogue = true, @JsonKey(name: 'est_active') this.estActive = true, @JsonKey(name: 'nb_partenaires') this.nbPartenaires, final  List<Categorie> enfants = const <Categorie>[]}): _typesArticles = typesArticles,_enfants = enfants;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,nom,slug,description,icone,imageCouverture,parent,modeTransaction,ordre,const DeepCollectionEquality().hash(_typesArticles),afficheCatalogue,estActive,nbPartenaires,const DeepCollectionEquality().hash(_enfants));
