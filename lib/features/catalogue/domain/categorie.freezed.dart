...
mixin _$Categorie {
 ...
 int get id; String get nom; String get slug; String get description; String get icone;@JsonKey(name: 'image_couverture') String? get imageCouverture; int? get parent;@JsonKey(name: 'mode_transaction') String get modeTransaction; int get ordre; List<Categorie> get enfants;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Categorie&&(identical(other.id, id) || other.id == id)&&(identical(other.nom, nom) || other.nom == nom)&&(identical(other.slug, slug) || other.slug == slug)&&(identical(other.description, description) || other.description == description)&&(identical(other.icone, icone) || other.icone == icone)&&(identical(other.imageCouverture, imageCouverture) || other.imageCouverture == imageCouverture)&&(identical(other.parent, parent) || other.parent == parent)&&(identical(other.modeTransaction, modeTransaction) || other.modeTransaction == modeTransaction)&&(identical(other.ordre, ordre) || other.ordre == ordre)&&const DeepCollectionEquality().equals(other.enfants, enfants));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,nom,slug,description,icone,imageCouverture,parent,modeTransaction,ordre,const DeepCollectionEquality().hash(enfants));

@override
String toString() {
  return 'Categorie(id: $id, nom: $nom, slug: $slug, description: $description, icone: $icone, imageCouverture: $imageCouverture, parent: $parent, modeTransaction: $modeTransaction, ordre: $ordre, enfants: $enfants)';
}
...
@useResult
$Res call({
 int id, String nom, String slug, String description, String icone,@JsonKey(name: 'image_couverture') String? imageCouverture, int? parent,@JsonKey(name: 'mode_transaction') String modeTransaction, int ordre, List<Categorie> enfants
});
...
/// Create a copy of Categorie
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? nom = null,Object? slug = null,Object? description = null,Object? icone = null,Object? imageCouverture = freezed,Object? parent = freezed,Object? modeTransaction = null,Object? ordre = null,Object? enfants = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String nom,  String slug,  String description,  String icone, @JsonKey(name: 'image_couverture')  String? imageCouverture,  int? parent, @JsonKey(name: 'mode_transaction')  String modeTransaction,  int ordre,  List<Categorie> enfants)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Categorie() when $default != null:
return $default(_that.id,_that.nom,_that.slug,_that.description,_that.icone,_that.imageCouverture,_that.parent,_that.modeTransaction,_that.ordre,_that.enfants);case _:
  return orElse();
...
class _Categorie implements Categorie {
  const _Categorie({required this.id, required this.nom, required this.slug, this.description = '', this.icone = '', @JsonKey(name: 'image_couverture') this.imageCouverture, this.parent, @JsonKey(name: 'mode_transaction') this.modeTransaction = '', this.ordre = 0, final  List<Categorie> enfants = const <Categorie>[]}): _enfants = enfants;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Categorie&&(identical(other.id, id) || other.id == id)&&(identical(other.nom, nom) || other.nom == nom)&&(identical(other.slug, slug) || other.slug == slug)&&(identical(other.description, description) || other.description == description)&&(identical(other.icone, icone) || other.icone == icone)&&(identical(other.imageCouverture, imageCouverture) || other.imageCouverture == imageCouverture)&&(identical(other.parent, parent) || other.parent == parent)&&(identical(other.modeTransaction, modeTransaction) || other.modeTransaction == modeTransaction)&&(identical(other.ordre, ordre) || other.ordre == ordre)&&const DeepCollectionEquality().equals(other._enfants, _enfants));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,nom,slug,description,icone,imageCouverture,parent,modeTransaction,ordre,const DeepCollectionEquality().hash(_enfants));
...
/// Create a copy of Categorie
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? nom = null,Object? slug = null,Object? description = null,Object? icone = null,Object? imageCouverture = freezed,Object? parent = freezed,Object? modeTransaction = null,Object? ordre = null,Object? enfants = null,}) {
