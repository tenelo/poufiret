...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,nomCommerce,typePartenaire,typeLibelle,description,logo,photoCouverture,adresse,quartier,secteur,ville,descriptionAcces,telephonePro,whatsapp,emailPro,nbVues,nombreLikes,estLikeParMoi,estFavoriParMoi]);
